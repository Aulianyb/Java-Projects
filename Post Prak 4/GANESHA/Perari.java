...
public class Perari extends Car{//Jangan lupa tambahkan kata kunci untuk melakukan polymorphism antar kelas
    ...
    public String printDescription(){
        ...
        if (isInsuranced){
            return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki kecepatan rata-rata %d km/h, dan sedang dalam perlindungan asuransi", this.getNumberOfWheels(), this.getEngineCapacity(), averageSpeed);
        }
        else{
            return String.format("Mobil ini memiliki %d roda dengan kapasitas mesin %d cc, memiliki kecepatan rata-rata %d km/h, dan sedang tidak dalam perlindungan asuransi", this.getNumberOfWheels(), this.getEngineCapacity(), averageSpeed);
        }
    }
}
